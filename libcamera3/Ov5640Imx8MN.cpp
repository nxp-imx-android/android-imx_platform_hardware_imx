...
Ov5640Imx8MN::Ov5640Imx8MN(int32_t id, int32_t facing, int32_t orientation, char *path)
    : Camera(id, facing, orientation, path)
{
    mVideoStream = new Ov5640Stream(this);
}

Ov5640Imx8MN::~Ov5640Imx8MN()
{
}


int Ov5640Imx8MN::Ov5640Stream::getCaptureMode(int width, int height)
{
    int index = 0;
    int ret = 0;
    int capturemode = 0;
...
status_t Ov5640Imx8MN::initSensorStaticData()
{
...
PixelFormat Ov5640Imx8MN::getPreviewPixelFormat()
{
    ALOGI("%s", __func__);
...
// configure device.
int32_t Ov5640Imx8MN::Ov5640Stream::onDeviceConfigureLocked()
{
    ALOGI("%s", __func__);
    int32_t ret = 0;
    if (mDev <= 0) {
